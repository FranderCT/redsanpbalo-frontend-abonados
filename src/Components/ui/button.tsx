  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 text-white font-semibold",
        outline:
          "border border-input border-[#1789FC] bg-background text-[#1789FC] font-semibold shadow-sm hover:bg-[#1789FC] hover:text-accent-foreground hover:text-white",
        secondary:
