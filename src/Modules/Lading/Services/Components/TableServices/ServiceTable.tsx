...
import ServicePager from "../PaginationServices/ServicePager";
...
export default function ServiceTable({ data, total, page, pageCount, onPageChange }: Props) {
  const [editingService, setEditingService] = useState<Service | null>(null);

  const table = useReactTable({
    data,
    columns: ServiceColumns((service) => setEditingService(service)),
