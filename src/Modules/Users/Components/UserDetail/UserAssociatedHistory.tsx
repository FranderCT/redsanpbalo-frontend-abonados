import { Calendar, FileText, Hash, UserPlus } from "lucide-react";
import { Badge } from "@/Components/ui/badge";
import { Card, CardContent, CardHeader, CardTitle } from "@/Components/ui/card";
import { Separator } from "@/Components/ui/separator";
import { Skeleton } from "@/Components/ui/skeleton";
import { useGetReqAssociatedByUser } from "../../../Requests/RequestAssociated/Hooks/ReqAssociatedHooks";
...
const UserAssociatedHistory = ({ userId }: Props) => {
  const { requests, isLoading } = useGetReqAssociatedByUser(userId);
      ...
      <CardContent className="pt-4">
        {requests.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-2 py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">Sin solicitudes de asociado.</p>
          </div>
        ) : (
...
export default UserAssociatedHistory;
