...
import { useGetReqChangeNameMeterByUser } from "../../../Requests/RequestChangeNameMeter/Hooks/RequestChangeNameMeterHooks";
...
const UserChangeNameMeterHistory = ({ userId }: Props) => {
  const { requests, isLoading } = useGetReqChangeNameMeterByUser(userId);
      ...
      <CardContent className="pt-4">
        {requests.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-2 py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">Sin solicitudes de cambio de nombre del medidor.</p>
          </div>
        ) : (
...
export default UserChangeNameMeterHistory;
