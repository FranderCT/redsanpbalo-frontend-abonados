import { Calendar, FileText, ClipboardList, Droplets } from "lucide-react";
import { Badge } from "@/Components/ui/badge";
import { Card, CardContent, CardHeader, CardTitle } from "@/Components/ui/card";
import { Separator } from "@/Components/ui/separator";
import { Skeleton } from "@/Components/ui/skeleton";
import { useGetReqAvailWaterByUser } from "../../../Requests/RequestAvailabilityWater/Hooks/ReqAvailWaterHooks";
...
const UserAvailWaterHistory = ({ userId }: Props) => {
  const { requests, isLoading } = useGetReqAvailWaterByUser(userId);
      ...
      <CardContent className="pt-4">
        {requests.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-2 py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">Sin solicitudes de disponibilidad de agua.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="min-w-0 flex-1 space-y-1">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-muted-foreground">Solicitud #{req.Id}</span>
                  </div>
                  {req.Justification && (
...
export default UserAvailWaterHistory;
