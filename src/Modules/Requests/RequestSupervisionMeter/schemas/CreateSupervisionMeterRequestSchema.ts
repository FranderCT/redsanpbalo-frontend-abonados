...
export const CreateSupervisionMeterRequestSchema = z
  .object({
...
export type CreateSupervisionMeterRequestFormValues = z.infer<
  typeof CreateSupervisionMeterRequestSchema
>;
