...
export default function ReqSupervisionMeterHeaderBar({
  total,
  limit,
  search,
  requestStateId,
      ...
      <CardContent className="flex flex-col gap-4 pt-5">
        <div className="grid grid-cols-1 gap-3 xl:grid-cols-[160px_240px_minmax(0,1fr)_auto]">
          <div className="flex flex-col gap-2">
            ...
            >
              <SelectTrigger id="req-supervision-limit" className="rounded-none">
          ...
          <div className="flex flex-col gap-2">
            <Label
              htmlFor="req-supervision-request-state"
              className="text-xs font-medium uppercase tracking-wide text-slate-500"
            >
              Estado de solicitud
            </Label>
            <Select
              ...
              onValueChange={(value) =>
                onStateRequestChange(value === "all" ? undefined : Number(value))
              }
              disabled={!!statesLoading}
            >
              <SelectTrigger id="req-supervision-request-state" className="rounded-none">
          ...
          <div className="flex min-w-0 flex-col gap-2">
            <Label
              htmlFor="req-supervision-search"
              className="text-xs font-medium uppercase tracking-wide text-slate-500"
            >
              Buscar
            </Label>
            <div className="relative">
              ...
              <Input
                id="req-supervision-search"
                type="search"
                value={search}
                onChange={(event) => onSearchChange(event.target.value)}
                autoComplete="off"
                placeholder="Buscar por solicitante, cédula o justificación"
