        ...
        <div className="bg-white border-b border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-900 font-medium">{request.Name} {request.Surname1} {request.Surname2}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
              <span className="text-xs text-gray-500 uppercase tracking-wide font-semibold block mb-1">Cédula</span>
              <p className="text-gray-900 font-medium">{request.IDcard}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
              <span className="text-xs text-gray-500 uppercase tracking-wide font-semibold block mb-1">NIS</span>
              <p className="text-gray-900 font-medium">{request.NIS}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
            ...
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-900 font-medium">{request.User?.PhoneNumber}</p>
            </div>
            {request.Justification && (
              <div className="md:col-span-3 bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-gray-900 leading-relaxed">{request.Justification}</p>
              </div>
            )}
          </div>
