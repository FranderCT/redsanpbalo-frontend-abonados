...
export const CreateChangeMeterRequestAbonadoSchema = z
  .object({
...
export type CreateChangeMeterRequestAbonadoFormValues = z.infer<
  typeof CreateChangeMeterRequestAbonadoSchema
>;
