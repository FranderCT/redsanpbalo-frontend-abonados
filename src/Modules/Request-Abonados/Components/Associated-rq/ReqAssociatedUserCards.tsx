...
import { formatAssociatedRequestDate } from "../../../Requests/RequestAssociated/utils/associatedRequestDate";
...
function ReqAssociatedUserCard({
  req,
  onOpenDetails,
  onOpenComments,
}: {
        ...
        <div className="grid grid-cols-1 gap-3 text-sm text-slate-600 sm:grid-cols-2">
          <div className="border-l-2 border-slate-200 pl-3">
            ...
            <p className="mt-1 font-medium text-slate-900">
              {formatAssociatedRequestDate(req.Date)}
            </p>
          </div>
          <div className="border-l-2 border-slate-200 pl-3">
...
export default function ReqAssociatedUserCards({
  data,
  total,
  page,
  pageCount,
