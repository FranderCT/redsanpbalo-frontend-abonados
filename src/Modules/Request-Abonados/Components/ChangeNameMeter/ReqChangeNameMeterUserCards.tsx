...
import { CommentsChangeNameMeterModal } from "../../../Requests/RequestChangeNameMeter/Components/Comments/CommentsChangeNameMeterModal";
import { formatChangeNameMeterDate } from "../../../Requests/RequestChangeNameMeter/utils/changeNameMeterDate";
...
function ReqChangeNameMeterUserCard({
  req,
  onOpenDetails,
  onOpenComments,
}: {
  req: ReqChangeNameMeter;
  onOpenDetails: (req: ReqChangeNameMeter) => void;
...
export default function ReqChangeNameMeterUserCards({
  data,
  total,
  page,
  pageCount,
