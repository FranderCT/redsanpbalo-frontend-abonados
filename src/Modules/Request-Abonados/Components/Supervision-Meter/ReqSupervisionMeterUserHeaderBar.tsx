...
export default function ReqSupervisionMeterUserHeaderBar({
  total,
  limit,
  search,
  requestStateId,
      ...
      <CardContent className="flex flex-col gap-4 pt-5">
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[160px_240px_minmax(0,1fr)_auto]">
          <div className="flex flex-col gap-2">
            <Label
              htmlFor="req-supervision-user-limit"
              className="text-xs font-medium uppercase tracking-wide text-slate-500"
            >
              Filas por página
            </Label>
            <Select value={String(limit)} onValueChange={(value) => onLimitChange(Number(value))}>
              <SelectTrigger id="req-supervision-user-limit" className="rounded-none">
          ...
          <div className="flex flex-col gap-2">
            <Label
              htmlFor="req-supervision-user-state"
              className="text-xs font-medium uppercase tracking-wide text-slate-500"
            >
              Estado
            </Label>
            ...
            >
              <SelectTrigger id="req-supervision-user-state" className="rounded-none">
          ...
          <div className="flex min-w-0 flex-col gap-2">
            <Label
              htmlFor="req-supervision-user-search"
              className="text-xs font-medium uppercase tracking-wide text-slate-500"
            >
              Buscar
            </Label>
            <div className="relative">
              ...
              <Input
                id="req-supervision-user-search"
                name="req-supervision-user-search"
                type="search"
                value={search}
