      ...
      <CardContent className="flex flex-col gap-4 pt-0">
        <div className="flex flex-wrap items-end gap-3">
          <div className="flex min-w-[140px] flex-col gap-2">
            <Label htmlFor="category-limit-select">Filas por página</Label>
            <Select value={String(limit)} onValueChange={(value) => onLimitChange(Number(value))}>
              <SelectTrigger id="category-limit-select" aria-label="Filas por página">
          ...
          <div className="flex min-w-[160px] flex-col gap-2">
            <Label htmlFor="category-state-filter">Estado</Label>
            <Select value={state} onValueChange={(value) => onFilterChange(value as CategoryStateFilter)}>
              <SelectTrigger id="category-state-filter" aria-label="Filtrar por estado">
