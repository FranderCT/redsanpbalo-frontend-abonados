...
const CreateMaterialModal = () => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value, formApi }) => {
      try {
        await createMaterialMutation.mutateAsync(value);
    ...
    <div>
      ...
      >
        ...
        <div className="px-6 py-4 text-[#091540]">
          <h3 className="text-xl font-semibold">Crear Material</h3>
            ...
            <form.Field name="Name">
              {(field) => (
                ...
                <label className="grid gap-1">
                  <span className="text-sm text-gray-700">Nombre del Material</span>
                  <input
                    autoFocus
